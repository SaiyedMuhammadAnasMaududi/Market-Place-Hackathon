// app/Home/reservation/page.tsx
"use client";
import React, { useEffect, useState } from "react";
import { createClient } from "@sanity/client";
import Link from "next/link"; // Import L
...
const ReservationPage = () => {
  ...
  const handleSearch = (filteredItems: Reservation[]) => {
  ...
  return (
    <div className="bg-gray-50 min-h-screen font-sans">
      ...
      {/* Search Component */}
      <Search items={reservations} onSearch={handleSearch} />
