...
const Belowheader = () => {
  return (
    <div
      className={`w-full md:h-[74px] h-auto flex flex-wrap-reverse bg-white text-topheadertext justify-between py-2 md:py-0 md:items-center ${inter.className}`}
    >
      ...
      <div className="w-full md:w-[60%] flex flex-wrap justify-between items-center text-topheadertext py-2 sm:py-0 mx-[5%]">
        ...
        <Link href="../details" aria-label="Go to shop page">
          <p className="text-[14px] font-medium">Catering</p>
        </Link>
        <Link href="../products" aria-label="Go to product page">
          <p className="text-[14px] font-medium">Decoration</p>
        </Link>
        <Link href="../questions" aria-label="Go to pages page">
