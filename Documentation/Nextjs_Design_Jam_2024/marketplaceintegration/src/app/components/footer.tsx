  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col space-y-3">
        ...
        <p className="text-[16px] font-medium text-[#272343]">Decoration</p>
        <p className="text-[16px] font-medium text-[#272343]">Catering</p>
        <p className="text-[16px] font-medium text-[#029fae] underline decoration-[#029fae]">
          Reserving Destination
        </p>
        <p className="text-[16px] font-medium text-[#272343]">Event Consultancy</p>
      </div>
